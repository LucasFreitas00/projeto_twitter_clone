<?php
  ...
  class Route extends Bootstrap {
    ...
    protected function initRoutes() {
      ...
      $routes['registrar'] = array('route' => '/registrar', 
      'controller' => 'indexController',
      'action' => 'registrar');
      ...
      $routes['quem_seguir'] = array('route' => '/quem_seguir', 
      'controller' => 'AppController',
      'action' => 'quem_seguir');

      $routes['acao'] = array('route' => '/acao', 
      'controller' => 'AppController',
      'action' => 'acao');

      $routes['deletar_tweet'] = array('route' => '/deletar_tweet', 
      'controller' => 'AppController',
